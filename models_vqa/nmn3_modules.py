...
class Modules:
    def __init__(self, image_feat_grid, word_vecs, encoder_states, num_choices):
        ...
        self.ColorModule(input_att, time_idx, batch_idx, reuse=False)
        self.SentimentModule(input_att, time_idx, batch_idx, reuse=False)
        self.SceneModule(input_att, time_idx, batch_idx, reuse=False)
        self.ActivityModule(input_att, time_idx, batch_idx, reuse=False)
    ...
    def DescribeCountModule(self, input_0, time_idx, batch_idx,
        map_dim=1024, scope='DescribeCountModule', reuse=True):
        # In TF Fold, batch_idx and time_idx are both [N_batch, 1] tensors
    ...
    def ColorModule(self, input_0, time_idx, batch_idx,
        map_dim=1024, scope='ColorModule', reuse=True):
        # In TF Fold, batch_idx and time_idx are both [N_batch, 1] tensors
    ...
    def SentimentModule(self, input_0, time_idx, batch_idx,
        map_dim=1024, scope='SentimentModule', reuse=True):
        # In TF Fold, batch_idx and time_idx are both [N_batch, 1] tensors
    ...
    def SceneModule(self, input_0, time_idx, batch_idx,
        map_dim=1024, scope='SceneModule', reuse=True):
        # In TF Fold, batch_idx and time_idx are both [N_batch, 1] tensors
    ...
    def ActivityModule(self, input_0, time_idx, batch_idx,
        map_dim=1024, scope='ActivityModule', reuse=True):
        # In TF Fold, batch_idx and time_idx are both [N_batch, 1] tensors
